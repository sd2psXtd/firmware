...
static void update_ps2_main_header(void) {
    ...
    else if (PS2_VARIANT_CONQUEST_CARD == settings_get_ps2_variant())
...
static void evt_switch_variant(lv_event_t *event) {
...

    {
        ...
        else if (settings_get_ps2_variant() == PS2_VARIANT_CONQUEST_CARD)
...
static void create_menu_screen(void) {
    ...
    lv_obj_t *ps2_page = ui_menu_subpage_create(menu, "PS2 Settings");
    {
        ...
        lv_obj_t *variant_page = ui_menu_subpage_create(menu, "Variant");
        {
            ...
            lv_obj_add_event_cb(cont, evt_switch_variant, LV_EVENT_CLICKED, (void*)(intptr_t)PS2_VARIANT_CONQUEST_CARD);
        }
        {
            char text[9] = {};
            if (settings_get_ps2_variant() == PS2_VARIANT_RETAIL)
                ...
                snprintf(text, ARRAY_SIZE(text), "{SCII}>");
